#!/usr/bin/env python3
# Script copied from: https://5harad.com/mse231/assets/tweet_stream.py
# No claimed copyright by repository owners, for testing and educational purposes only.
  ...
  while True:
    try:
      if flags.filter:
        ...
        twitterstream.filter(track=flags.filter)
      else:
